"""
Django settings for myapp_48334 project.
...
WSGI_APPLICATION = 'myapp_48334.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "myapp_48334 API",
    "DESCRIPTION": "API documentation for myapp_48334 App",
    "VERSION": "v1",
}
